...
<head>
  ...
  <style>
    ...
    .sidebar { background: #fff; border-right: 1px solid #dee2e6; padding: 1rem; height: 89vh; }
        ...
        <div class="row card-section">
          <div class="col-md-6 mb-4">
            <div class="card shadow-sm">
              ...
              <div class="card-body">
                <p class="mb-1">
                  <strong><?php echo htmlspecialchars($acct['F_name'] . ' ' . $acct['L_name']); ?></strong>
                </p>
                <p class="text-muted mb-0"><?php echo htmlspecialchars($acct['Email']); ?></p>
                <p class="text-muted"><?php echo htmlspecialchars($acct['Phone_number']); ?></p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 mb-4">
            <div class="card shadow-sm">
              <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="customer_address.php"><i class="fas fa-pen"></i></a>
              </div>
              <div class="card-body">
                <?php if ($addr): ?>
                  <p class="mb-1"><strong><?php echo htmlspecialchars($acct['F_name'] . ' ' . $acct['L_name']); ?></strong></p>
                  <p class="mb-1"><?php echo htmlspecialchars($addr['delivery_location']); ?></p>
                  <p class="mb-1"><?php echo htmlspecialchars($addr['apartment_number']); ?></p>
                  <p class="mb-0"><?php echo htmlspecialchars($addr['phone_number']); ?></p>
                <?php else: ?>
                  <p>No default address set.</p>
                  <a href="customer_address.php" class="btn btn-sm btn-primary">Add Address</a>
                <?php endif; ?>
              </div>
            </div>
          </div>
